...
const TeamMenber = () => {
    ...
    return (
        <div className="md:py-20 py-10">
          ...
          <h3 className="mb-5 text-center  text-4xl font-bold text-white" data-aos="flip-left">Meet The Team Section</h3>
          ...
          <div className=" space-y-3 flex justify-center items-center flex-col  text-center">
            ...
            <p className="text-xl text-white" data-aos="flip-left">Pavel Das</p>
            <p className="font-medium text-white" data-aos="flip-left">Expert for event Management and photography </p>
          </div>
          <div className="space-y-3 flex justify-center items-center flex-col  text-center">
            <img src="https://i.ibb.co/4TQ70Vm/member2.png" alt="" />
            <p className="text-xl text-white"data-aos="flip-left" >Pinky Hossain</p>
            <p className="font-medium text-white" data-aos="flip-left">Expert for event Management and photography </p>
          </div>
          <div className="space-y-3 flex justify-center items-center flex-col  text-center">
            <img src="https://i.ibb.co/C7vPW19/member3.png" alt="" />
            <p className="text-xl text-white" data-aos="flip-left">Habib Hossain</p>
            <p className="font-medium text-white" data-aos="flip-left">Expert for event Management and photography </p>
          </div>
